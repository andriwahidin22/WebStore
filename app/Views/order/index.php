...
<body>
    <main>
        ...
        <div class="container mt-5">
            <h1 class="mb-4 text-center">Form Pembelian</h1>
            ...
            <div class="card shadow-lg">
                <div class="card-body">
                    <form action="/order/processOrder" method="post">
                        <input type="hidden" name="produk_id" value="<?= $produk['id'] ?>">

                        <!-- Nama Produk -->
                        <div class="mb-3">
                            <label for="nama_produk" class="form-label"><i class="bi bi-box-seam"></i> Nama Produk</label>
                            <input type="text" class="form-control" id="nama_produk" value="<?= $produk['nama_produk'] ?>" readonly>
                        </div>

                        <!-- Harga -->
                        <div class="mb-3">
                            <label for="harga" class="form-label"><i class="bi bi-cash-stack"></i> Harga</label>
                            <input type="text" class="form-control" id="harga" value="Rp <?= number_format($produk['harga'], 0, ',', '.') ?>" readonly>
                        </div>

                        <!-- Jumlah -->
                        <div class="mb-3">
                            <label for="quantity" class="form-label"><i class="bi bi-cart"></i> Jumlah</label>
                            <input type="number" name="quantity" id="quantity" class="form-control" min="1" max="<?= $produk['stok'] ?>" required>
                            <small class="form-text text-muted">Stok tersedia: <?= $produk['stok'] ?></small>
                        </div>

                        <!-- Alamat -->
                        <div class="mb-3">
                            <label for="alamat" class="form-label"><i class="bi bi-geo-alt"></i> Alamat Pengiriman</label>
