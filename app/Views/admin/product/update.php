                        ...
                        <div class="card-body">
                            <form action="<?= base_url('admin/product/update/' . $product['id']); ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_produk" name="nama_produk" value="<?= esc($product['nama_produk']); ?>" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="<?= base_url('uploads/' . $product['gambar']); ?>" alt="Thumbnail" style="width: 100px;">
                                </div>

                                <div class="form-group">
                                    <label for="harga">Price</label>
                                    <input type="number" class="form-control" id="harga" name="harga" value="<?= esc($product['harga']); ?>" required>
                                </div>

                                <div class="form-group">
                                    <label for="spesifikasi">Specification</label>
                                    <textarea class="form-control" id="spesifikasi" name="spesifikasi" rows="4" required><?= esc($product['spesifikasi']); ?></textarea>
                                </div>

                                <div class="form-group">
                                    <label for="stok">Stock</label>
                                    <input type="number" class="form-control" id="stok" name="stok" value="<?= esc($product['stok']); ?>" required>
                                </div>
